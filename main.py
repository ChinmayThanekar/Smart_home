...
# CONFIG
# =========================
st.set_page_config(page_title="SmartNest Automation", page_icon="🏠", layout="wide")
...
if col2.button("About"): st.session_state.page = "About"
if col3.button("Products"): st.session_state.page = "Products"
if col4.button("Contact"): st.session_state.page = "Contact"
...
# =========================
    ...
    st.write("We provide smart automation solutions across India.")
...
# =========================
    ...
    if not st.session_state.form_submitted:
        ...
        st.markdown("### 📞 Instant Contact Options")
